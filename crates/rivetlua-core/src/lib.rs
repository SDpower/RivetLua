...
pub use bytecode::{
    ...
    EncodedModule, EnvironmentSource, FrameLayout, Instruction, InstructionOffset, IrLimits,
    LuaProfile, Opcode, ProfileRequirement, ProtoId, RVLU_MAGIC, RVLU_NUMERIC_I64_F64, RVLU_V1,
